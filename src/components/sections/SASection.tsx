...
export default function SASection({ permission }: { permission: Permission }) {
  ...
  if (loading) return <div className="text-center py-12">Loading Section A orders...</div>;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-3xl font-bold text-gray-900">⚙️ Section A Processing</h2>
          <p className="text-gray-600 mt-2">Process accepted orders in Section A</p>
        </div>
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg border-l-4 border-blue-500">
          ...
          <div className="text-gray-600 font-medium">Total SA Orders</div>
        </div>
      </div>
      ...
      <div className="grid gap-6">
            ...
            <div className="space-y-2 mb-4">
              ...
              {order.items.map((item, idx) => (
                <div key={idx} className="flex justify-between bg-white rounded-lg p-3 border border-gray-200">
                  <div>
                    <span className="font-semibold text-orange-600">Type {item.itemType}</span>
        ...
        {filteredOrders.length === 0 && (
          <div className="text-center py-16 bg-white rounded-2xl shadow-lg">
            ...
            <p className="text-xl text-gray-600 font-medium">No {filter} orders in Section A</p>
          </div>
        )}
      </div>
    </div>
