    ...
    return (
      <div className="flex items-center justify-center py-16 md:py-32 px-4">
        <div className="text-center">
          ...
          <p className="text-base md:text-xl text-gray-600 font-medium">Loading packaging orders...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4 md:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <div>
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900">📦 Packaging</h2>
          <p className="text-sm md:text-base text-gray-600 mt-1 md:mt-2">Pack processed orders for dispatch</p>
        </div>
      ...
      <div className="grid grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4">
        <div className="bg-white rounded-xl md:rounded-2xl p-4 md:p-6 shadow-lg border-l-4 border-purple-500">
        ...
        <div className="bg-white rounded-xl md:rounded-2xl p-4 md:p-6 shadow-lg border-l-4 border-violet-500">
          ...
          <div className="text-xs md:text-base text-gray-600 font-medium">Packaged</div>
        </div>
        ...
        <div className="bg-white rounded-xl md:rounded-2xl p-4 md:p-6 shadow-lg border-l-4 border-indigo-500 col-span-3 lg:col-span-1">
        ...
        {filteredOrders.map(order => (
          ...
          >
            ...
            <div className="mb-3 md:mb-4">
              ...
              {order.packagedBy && (
                <p className="text-xs md:text-sm text-purple-600 font-medium mt-1">
              ...
              {order.items.map((item, idx) => (
                <div key={idx} className="flex flex-col sm:flex-row sm:justify-between gap-2 bg-white rounded-lg p-3 border border-gray-200">
                  <div className="flex-1">
                    <span className="font-semibold text-sm md:text-base text-purple-600">Type {item.itemType}</span>
              ...
              {permission === 'read_write' && order.status === 'PACKAGING_PENDING' && (
                <div className="flex flex-col sm:flex-row gap-2 md:gap-3">
                  <button
                    ...
                    className="flex-1 px-4 md:px-6 py-2.5 md:py-3 bg-gradient-to-r from-violet-500 to-violet-600 text-white rounded-lg md:rounded-xl font-bold text-sm md:text-base hover:shadow-lg transition-all"
                  >
                    ✅ Mark as Packaged
                  </button>
                  <button
